...
// mesa = restaurant: Menu layout
const SITE_STYLE_LABEL = 'Menu layout'
const SITE_STYLE_LABELS: Record<string, string> = { '1': 'Ledger', '2': 'Tasting', '3': 'Chalkboard' }
...
const sectionTargets = {
  ...
  subhero:   { selectors: ['.ap-subhero'],                               route: '/menu' },
  footer:    { selectors: ['.ap-footer'],                                route: '/' },
  site:      { selectors: ['.ap-menu', '.ap-amenities', '.ap-products', '.ap-categories'], route: '/menu' },
